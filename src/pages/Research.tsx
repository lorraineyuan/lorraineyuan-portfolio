      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-20">
          ...
          <div>
            ...
            <Collapsible open={isAbstractOpen} onOpenChange={setIsAbstractOpen} className="mb-4">
              <CollapsibleTrigger className="flex items-center gap-2 text-lg font-semibold mb-2 hover:text-sidebar-accent transition-colors">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold mb-2">Flash Talk</h3>

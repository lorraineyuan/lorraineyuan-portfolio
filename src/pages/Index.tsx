...
export default function Index() {
  ...
  return (
    <Layout>
      {/* Home Section */}
      <section id="home" className="flex items-center justify-center px-4 sm:px-8 md:px-10 py-8 md:py-12 bg-[#FFFEFB]">
      ...
      {/* About Section */}
      <section id="about" className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-10 bg-[#E5E4E0]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6 text-lg sm:text-xl leading-relaxed text-foreground mb-12 md:mb-16">
            ...
            <p>
              ...
              In a complementary empirical stream, I apply transformer models to a large-scale real-world data to evaluate the
          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className="space-y-4 text-base sm:text-lg text-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  2026 INFORMS Annual Meeting, San Francisco — <em>October 25–28</em>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Research Section */}
      <section id="research" className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-10 bg-[#FFFEFB]">
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex-1 flex flex-col justify-between h-full">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        <span className="inline-flex items-center justify-center bg-primary text-primary-foreground px-3 py-1 rounded text-sm font-extrabold text-center">
      ...
      {/* Teaching Section */}
      <section id="teaching" className="py-8 sm:py-10 md:py-12 px-4 sm:px-8 md:px-10 bg-[#E5E4E0]">
        <div className="max-w-7xl mx-auto">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 py-1">
                      ...
                      <div>
                        <h4 className="text-lg font-bold mb-1">Guest Lecturer, AI and Digital Transformations</h4>
                    ...
                    <div className="flex items-start gap-3 py-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-black mt-[0.4375rem] flex-shrink-0" />
                      <div>
                        <h4 className="text-lg font-bold mb-1">Co-instructor, Managing Operations</h4>
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div className="flex items-start gap-3 py-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <h4 className="text-lg font-bold">Business Data Analysis with SQL</h4>
                  ...
                  <div className="flex items-start gap-3 py-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <h4 className="text-lg font-bold">Generative AI for Business Transformation</h4>
                  ...
                  <div className="flex items-start gap-3 py-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <h4 className="text-lg font-bold">Managing Operations</h4>
                  ...
                  <div className="flex items-start gap-3 py-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <h4 className="text-lg font-bold">Operations Management</h4>
                  ...
                  <div className="flex items-start gap-3 py-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline justify-between gap-2">
                        <h4 className="text-lg font-bold">Innovation & New Venture Creation / The Customer Experience</h4>
      ...
      <section id="service-awards" className="py-8 sm:py-10 md:py-12 px-4 sm:px-8 md:px-10 bg-[#FFFEFB]">
        <div className="max-w-7xl mx-auto">
      ...
      <section id="pronouncing-my-name" className="py-8 sm:py-10 md:py-12 px-4 sm:px-8 md:px-10 bg-[#E5E4E0]">
        <div className="max-w-7xl mx-auto">

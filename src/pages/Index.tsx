            ...
            <div className="flex flex-col md:flex-row md:items-stretch gap-8 md:gap-12">
              ...
              <div className="flex-1 flex flex-col justify-between md:gap-10">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="pl-6 py-2 relative before:content-[.__.] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-foreground/40">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div className="pl-6 py-1.5 relative before:content-[.__.] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-foreground/40">
